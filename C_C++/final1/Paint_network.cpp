#include "Paint_network.h"
    ...
    int PNET::recieve_packet(int sfd, int *buff, size_t size)// point of paint tool are transferred through here
    {
        int numRead;
    ...
    int PNET::send_packet(int sfd, int *buff, size_t size)// point of paint tool are sent through here
    {
        int numWrite;
