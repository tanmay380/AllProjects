...
public class FPSController : NetworkBehaviour
{
    ...
    public static float damageAmount = 10f;
	...
	new Color(252, 208, 193, 255), new Color(0, 0, 0, 0)};
	public Renderer playerRanderer;
...
void Start()
    {
		...
		if (!isLocalPlayer)
		{
			for (int i = 0; i < playerRanderer.materials.Length; i++)
			{
				playerRanderer.materials[i].color = playerColors[i];
			}
		}
