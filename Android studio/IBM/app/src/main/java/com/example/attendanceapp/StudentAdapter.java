...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.ClassViewHolder> {
    ...
    private int getColor(int position) {
        ...
        if (status.equals("P")) return Color.parseColor("#" + Integer.toHexString(ContextCompat.getColor(context, R.color.present)));
        else if(status.equals("A")) return Color.parseColor("#" + Integer.toHexString(ContextCompat.getColor(context, R.color.absent)));
